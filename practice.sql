...
SELECT e.CateID,e.CateName,e.Description,p.PartName,p.Price,p.Quantity,p.Warranty,p.Photo FROM Categories e
JOIN Parts p ON p.CateID=e.CateID
WHERE e.CateName='CPU'
GO
...
SELECT P.PartID, P.PartName, E.CateName, P.Price, P.Quantity FROM Parts P
JOIN Categories E ON E.CateID=P.CateID
GO
